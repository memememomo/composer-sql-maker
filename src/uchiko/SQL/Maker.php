...
class Maker {
    ...
    public function __construct($args) {
        ...
        $this->select_class =
            ...
            ? '\uchiko\SQL\Maker\Select\Oracle'
            : '\uchiko\SQL\Maker\Select';
    ...
    public function quote($label) {
        return Util::quoteIdentifier($label, $this->quote_char, $this->name_sep);
    }
