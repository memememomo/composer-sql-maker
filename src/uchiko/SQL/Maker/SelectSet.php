...
class SelectSet {
    ...
    public function __construct($args) {
        throw "Missing mandatory parameter 'operator' for new SQL\Maker\SelectSet" unless $args['operator'];
    ...
    private function quote($label) {
        return SQL\Maker\Util::quoteIdentifier($label, $this->quote_char, $this->name_sep);
    }
